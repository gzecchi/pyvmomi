...
def main():
    ...
    try:
        ...
        # List Network List
        net_cli = cli.get("network.ip.interface")
        print(net_cli.List())
        print("=======================================================================")
        for currNet in net_cli.List():
            print("Name: %s\tMAC Address: %s\tPortGroup: %s" % (currNet.Name, currNet.MACAddress, currNet.Portgroup))
